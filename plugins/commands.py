...
main_buttons = [[
    InlineKeyboardButton('❣️ ᴅᴇᴠᴇʟᴏᴘᴇʀ ❣️', url='https://t.me/KILLERxVIPP')
],[
...
async def helpcb(bot, query):
    buttons = [[
        InlineKeyboardButton('🤔 ʜᴏᴡ ᴛᴏ ᴜsᴇ coming soon ❓', url='https://youtube.com/@killerxvip1?si=hov1I7PsJyXf5Olv')
    ],[
